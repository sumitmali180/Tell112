...
const CrimeReport = () => {
  ...
  const [formData, setFormData] = useState(initalFeilds);
...
>
  <div className="max-w-4xl w-full space-y-6 p-8 mb-10 rounded-lg shadow-xl backdrop-blur-md bg-white/10 text-white">
    <h2 className="text-3xl font-bold text-center">Create Crime and Incident Report</h2>
